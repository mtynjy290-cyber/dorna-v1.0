...
const INITIAL_PROJECTS_SEED: ProjectRecord[] = [
  ...
  {
    id: 'proj-6',
    title: 'شوروم مرکزی برندهای لوکس',
      ...
      const initialSeed: InquiryRecord[] = [
        {
          ...
          client_name: 'مهندس رضایی (برج الماس نیاوران)',
        ...
        },
        {
          ...
          client_name: 'دکتر ستوده (کلینیک دندانپزشکی سعادت‌آباد)',
        ...
        },
        {
          ...
          client_name: 'شرکت مهندسی آریاسازان (زعفرانیه)',
